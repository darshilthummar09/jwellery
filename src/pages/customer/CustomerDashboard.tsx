...
const MY_ORDERS: Array<{ name: string; status: string; progress: number; eta: string }> = [];
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        <StatCard title="Active Orders"     value="0" icon={ShoppingBag}  color="emerald" />
        <StatCard title="Ready for Pickup"  value="0" icon={CheckCircle2} color="blue"    />
        <StatCard title="Avg. Delivery"     value="-" icon={Clock}        color="purple"  />
      </div>
