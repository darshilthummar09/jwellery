...
const ASSIGNED = [
  { name: 'Patel Wedding Set',    client: 'Priya Patel',  priority: 'High',   due: '20 Jul', status: 'In Progress' },
  { name: 'Custom Necklace',      client: 'Sunita Roy',   priority: 'Medium', due: '01 Aug', status: 'Design' },
  { name: 'Engagement Ring',      client: 'Kavya Iyer',   priority: 'High',   due: '28 Jul', status: 'Review' },
];
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        <StatCard title="Assigned Projects" value="3"  icon={ClipboardList} color="emerald" />
        <StatCard title="Completed"          value="14" icon={CheckCircle2}  color="blue"    />
        <StatCard title="Avg. Completion"    value="5d" icon={Clock}         color="purple"  />
      </div>
